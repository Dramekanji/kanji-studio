const About = () => {
  return (
    <div className="flex items-center justify-center min-h-[700px] bg-white text-black p-10">
      <div className="max-w-2xl text-center">
        <h2 className="text-8xl font-semibold">Who Are We?</h2>
        <h1 className="text-2xl font-bold my-6">
          A group of passionate creatives that want to contribute and make a
          positive impact.
        </h1>
